...
<body class="homepage">
    ...
    <div class="container">
    	<div class="row travels_row">
    		<div class="pull-left travels_head">目的地 > 游记 > 修改游记</div>




                <form id="travelsForm" target="travelsFrame" class="form-horizontal" action="doTUpdate.php" method="post">
                    <fieldset>
                                <div class="col-md-6 col-xs-12 travels_content">
                                    <div class="travels_title"><b>修改游记</b></div>
                                    <div class="lab_title"><span>*</span>城市名:<small>(20个汉字之内)</small></div>
                                    <input id="travel_input" type="text" name="tname" value="<?php echo $travelsInfo['tname']; ?>">
                                    ...
                                    <input id="travel_input" type="text" name="tTitle" value="<?php echo $travelsInfo['tTitle']; ?>">
                                    <div class="lab_title"><span>*</span>正文:</div>
                                    <textarea id="travel_content" name="tEssay" placeholder="<?php echo $travelsInfo['tEssay']; ?>"></textarea>
