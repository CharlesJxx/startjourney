			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white picture"></i><span class="break"></span> 注册用户图片墙</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<div class="masonry-gallery">
							...
							<?php
								foreach ($headImgFind as $key => $value) {
									echo "<div id=\"image-1\" class=\"masonry-thumb\">";
									echo "<a style=\"background:url("."../".$value['headImg'].")\" title=\"".$value['username']."\" href=\""."../".$value['headImg']."\"><img class=\"grayscale\" src=\""."../".$value['headImg']."\" alt=\"".$value['username']."\"></a>";
									echo "</div>";
								}
							?>
