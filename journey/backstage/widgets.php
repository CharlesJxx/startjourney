	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="index.html"><span>Start Journey</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="widgets.php"><i class="icon-dashboard"></i><span class="hidden-tablet"> 小组件</span></a></li>
						...
						<li><a href="calendar.php"><i class="icon-calendar"></i><span class="hidden-tablet"> 日历</span></a></li>
						<li><a href="file-manager.php"><i class="icon-folder-open"></i><span class="hidden-tablet"> 文件管理中心</span></a></li>
						<li><a href="icon.php"><i class="icon-star"></i><span class="hidden-tablet"> Icons</span></a></li>
						<li><a href="login.php"><i class="icon-lock"></i><span class="hidden-tablet"> 登陆页</span></a></li>
					</ul>
				</div>
			</div>
			<!-- end: Main Menu -->
