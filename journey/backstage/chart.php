	...
	<!-- start: Header -->
		...
		<div class="row-fluid">
			...
			<div class="row-fluid sortable">
				...
				<div class="box">
					<div class="box-header">
						<h2><i class="halflings-icon white list-alt"></i><span class="break"></span>已注册用户数量</h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<p>已注册用户数：<?php echo $usersInfo->count();?></p>
			...
			<div class="row-fluid sortable">
				<div class="box">
					<div class="box-header">
						<h2><i class="halflings-icon white list-alt"></i><span class="break"></span>后台管理员数量</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
					...
					<div class="box-content">
						<p>已注册数量：<?php echo $adminInfo->count();?></p>
					</div>
				</div>
			...
			<div class="row-fluid sortable">
				<div class="box">
					<div class="box-header">
						<h2><i class="halflings-icon white list-alt"></i><span class="break"></span>已上传游记数量</h2>
						<div class="box-icon">
							<a href="#" class="btn-setting"><i class="halflings-icon white wrench"></i></a>
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
							<a href="#" class="btn-close"><i class="halflings-icon white remove"></i></a>
					...
					<div class="box-content">
						<p>已上传数量：<?php echo $travelsInfo->count();?></p>
					</div>
				</div>
