<?php
    ...
    if(isset($_GET['user'])){
        $username = $_GET['user'];
        if($mongo->findOne("travels",array("belongTo"=>$username))){
                                ...
                                <div class=\"blog-item\">
                                    <div class=\"row\">
                                        ...
                                        <div class=\"col-xs-12 col-sm-10 blog-content\">
                                            ...
                                            <h3>".$value['tEssay']."</h3>
                                            <a href=\"travelsUpdate.php?Title=".$value['tTitle']."\" class=\"btn-primary\">修改</a>
                                            <a href=\"travelsDelete.php?Title=".$value['tTitle']."\" class=\"btn-primary\">删除</a>
                                        </div>
                                    </div>   
                                </div>";}
                    ?>
